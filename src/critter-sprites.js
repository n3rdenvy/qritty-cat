...
export const INTERACTIONS = {
  ...
  tunnel: {
    ...
    catTortoiseshell: {
      ...
      fps: 4,
      getOn: [],
      // Last frame (the long side-view tube) dropped — it's ~2x wider than the
      // short-tube frames and read as the cat "getting bigger" mid-loop.
      run: [[8, 440, 63, 48], [80, 440, 72, 54], [156, 440, 72, 54], [231, 440, 70, 54], [303, 443, 71, 51], [376, 440, 70, 54], [448, 440, 71, 54], [521, 440, 70, 54], [594, 443, 70, 51], [666, 443, 70, 51], [738, 443, 71, 51], [811, 443, 76, 51]],
      slowDown: [],
      getOff: [],
    },
  },
